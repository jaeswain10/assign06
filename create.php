...
//$sql statement
$sql= "INSERT INTO income (fName,lName,social,spouseFname,spouseLname,spouseSocial,wages,taxableInterest,single,taxesWithheld)
VALUES
($fName','$lName','$social','$spouseFname','$spouseLname','$spouseSocial','$wages','$taxableInterest','$single','$taxesWithheld')";
//run sql query
